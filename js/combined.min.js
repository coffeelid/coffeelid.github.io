...
/*Instagram API*/
var tok = '10584144373.ad4ac43.353300f66f7e445f80e82a1240027d2f',
    userid = 10584144373, // ID пользователя
...
$.ajax({
	...
	success: function(result){
		for( x in result.data ) {
            $('.api-image:eq(' + x + ')').attr("src", result.data[x].images.standard_resolution.url);
        }
	},
